...
import { Users, ShoppingBag, Settings, ArrowRight, CreditCard, PackageCheck, AlertTriangle, AreaChart } from "lucide-react";
import Link from "next/link";
import { Button } from "@/components/ui/button";
// Progress component might not be used here, consider removing if not
...
const statCards = [
    ...
    { title: "New Customers", value: "245", change: "+12.1%", icon: Users, color: "text-blue-500", bgColor:"bg-blue-500/10" },
...
export default function AdminDashboardPage() {
  const quickLinks = [
    ...
    { name: "Manage Customers", href: "/admin/customers", icon: Users, description: "View and manage customer accounts." },
