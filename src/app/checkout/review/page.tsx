...
import { CartSummary } from '@/components/cart/CartSummary'; // Keep if needed, or remove if cost logic is duplicated

export default function OrderReviewPage() { // Renamed from OrderSummaryPage
  ...
  useEffect(() => {
    ...
    if (storedAddress) {
      ...
      // If no address, redirect to shipping step
  ...
  if (!shippingAddress) {
    // This case should be rare due to the redirect above, but it's a safe fallback.
    return <div className="text-center py-10">Shipping address not found. Please add an address. Redirecting...</div>;
  }
      ...
      <Card className="shadow-xl">
        <CardHeader>
          <CardTitle className="text-3xl font-headline text-primary flex items-center">
            <PackageCheck className="mr-3 h-7 w-7" /> Order Review
          </CardTitle>
