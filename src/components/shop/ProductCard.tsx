...
import { Heart, ShoppingCart, Star } from 'lucide-react'; // Removed MessageSquare as it's not used
...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className="group relative flex flex-col overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 h-full">
      <Link href={`/shop/products/${product.id}`} className="flex flex-col h-full"> {/* Path updated to /shop/products */}
